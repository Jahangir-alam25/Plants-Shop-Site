  ...
  return (
    <div className="bg-green-200">
      ...
      <div className="text-center pt-8">
        <h1 className="text-3xl font-bold text-gray-800">New Collection</h1>
        <p className="text-gray-600 mt-2 max-w-2xl mx-auto">
          Discover our New Collection — fresh arrivals of beautiful, healthy plants curated to brighten your home and workspace.
        </p>
      </div>
